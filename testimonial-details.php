...
<style>
    ...
    .testimonial-card div>div:nth-child(2) img {
        position: static;
        height: auto;
    }
</style>
                    ...
                    <div class="col-12 col-md-8 text-center">
                        ...
                        <div class="content  title-content" style="overflow-y: inherit;">
                            ...
                            for ($b = 0; $b <= count($data) - 1; $b++) {
                                if ($data[$b]['id'] == $_GET['id']) {
                            ?>
                                    <div class="testimonial-card p-3 rounded position-relative">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <h5 class="font-bold text-theme-primary mb-3 text-start"><?= $data[$b]['title'] ?></h5>
                                                <p class="font-semiBold mb-0 lh-1 opacity-75"><?= $data[$b]['parent_name'] ?></p>
                                                <p class="font-bold fs-6"><?= $data[$b]['child_name'] ?></p>
                                                <p class="lh-13">
                                                    <?= strip_tags($data[$b]['description']) ?>
                                                </p>
                                            </div>
                                            <div class="col-md-4">
                                                <img class="border border-0 rounded img-fluid w-100" src="<?= $data[$b]['attachment_path'] ?>"
                                                    alt="img">
                                            </div>
                                        </div>
                                    </div>
